...
image: "/images/blog/blog-hs-code-classification-herbal-ingredients-india-export.jpg"
imageAlt: "Customs classification documents and herbal ingredient samples used for HS code determination"
faqSchema: |
  {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What HS chapter do most Indian herbal ingredients fall under?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Raw and dried medicinal plant material - whole, cut, crushed, or powdered but not otherwise processed - generally falls under Chapter 12, heading 1211, which covers plants and parts of plants used primarily in perfumery, pharmacy, or for insecticidal and similar purposes. Once material is processed into a standardized extract, it typically moves to Chapter 13, heading 1302, which covers vegetable saps and extracts. Finished Ayurvedic medicaments put up for retail sale generally fall under Chapter 30, primarily heading 3004. The correct chapter depends on the degree of processing and the product's stated end use, not on the plant species itself."
        }
      },
      {
        "@type": "Question",
        "name": "Why does the same herbal ingredient sometimes get different HS codes from different exporters?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "The same botanical can legitimately classify under different codes depending on its form and marketed use. A dried, powdered root sold as a raw material typically falls under Chapter 12 (heading 1211). The same species standardized into a concentrated extract with a guaranteed active-constituent percentage typically falls under Chapter 13 (heading 1302). If it is formulated into a finished, retail-packaged Ayurvedic product with therapeutic claims, it falls under Chapter 30 (heading 3004). Exporters sometimes also disagree on classification within a single chapter, which is why buyers should ask for the exporter's stated HS code and the reasoning behind it rather than assuming uniformity across suppliers."
        }
      },
      {
        "@type": "Question",
        "name": "What happens if an exporter uses the wrong HS code?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "An incorrect HS code can result in the wrong duty rate being applied, disqualification from export incentive schemes such as RoDTEP, denial of preferential tariff treatment under a trade agreement even when the underlying product would otherwise qualify, and increased scrutiny or shipment holds at destination customs if the declared code does not match the product on inspection. Indian customs authorities can also assess penalties for misclassification found to be deliberate, separate from any additional duty owed. Getting the code right at the shipping bill stage matters more than most first-time exporters expect."
        }
      },
      {
        "@type": "Question",
        "name": "Does the HS code affect import duty for the buyer's country as well as export benefits in India?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes. The HS code drives duty and tax treatment at both ends of the transaction. On the export side, it determines Indian export incentive eligibility, such as RoDTEP credit rates, and which Certificate of Origin process applies for claiming preferential access under an agreement such as the India-UAE CEPA. On the import side, the buyer's customs authority uses the same or a locally extended version of the code to assess import duty, VAT or GST, and any additional import permit requirements. A mismatch between the exporter's declared code and the code the buyer's broker expects at destination is a common source of clearance delay."
        }
      },
      {
        "@type": "Question",
        "name": "How many digits does an HS code need to be for international trade?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "The World Customs Organization's Harmonized System defines codes to 6 digits, and this 6-digit level is recognized consistently across most countries. Beyond 6 digits, countries extend the code for their own tariff and statistical purposes - India's ITC-HS system extends to 8 digits, and other countries extend to 8 or 10 digits with their own national schedules. A 6-digit HS code should match between the exporting and importing country; the digits beyond that are jurisdiction-specific and are not directly comparable between an Indian shipping bill and a buyer's import declaration."
        }
      }
    ]
  }
...
> **Working with a supplier who can't explain their HS code choice?** Ayris Global verifies classification consistency and documentation accuracy across every supplier in our network before an introduction is made. [Get in touch](/contact/)
...
**Further Reading:** [Export Documentation Checklist for Indian Herbal Ingredients](/blog/export-documentation-checklist-herbal-ingredients-india/) | [Ashwagandha Extract Export from India: HS Classification and Documentation](/blog/ashwagandha-extract-export-india-buyers-guide/) | [India-UAE CEPA and Herbal Ingredient Imports](/blog/india-uae-cepa-herbal-ingredients-gcc/)
