...
image: "/images/blog/blog-usa-market-entry-herbal-ingredients-guide.jpg"
imageAlt: "Dried herbal botanicals and extract bottles representing USA market entry for Indian ingredient suppliers"
faqSchema: |
  {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Does the FDA approve herbal ingredients before they can be sold in the United States?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "No. The FDA does not pre-approve dietary supplements or the herbal ingredients inside them. Under the Dietary Supplement Health and Education Act of 1994, manufacturers and distributors are responsible for evaluating the safety and labeling of their own products before marketing, and the FDA's authority is primarily to act against a product after it reaches the market if it is found to be adulterated or misbranded. The one significant exception is a New Dietary Ingredient, an ingredient not already present in the food supply in an unaltered form, which requires a safety notification to FDA at least 75 days before the product enters interstate commerce."
        }
      },
      {
        "@type": "Question",
        "name": "What is the current US tariff rate on herbal ingredients imported from India?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "As of mid-2026, most imports from India face a flat 10 to 15 percent Section 122 surcharge on top of the standard MFN duty rate for the product's HTS classification, following the Supreme Court's February 2026 decision striking down the prior tariff structure. This Section 122 surcharge is explicitly temporary and is scheduled to expire around July 24, 2026 unless Congress acts to extend it. A separate, longer-term US-India Bilateral Trade Agreement remains under negotiation but had not entered into force as of this guide's publication. Suppliers and buyers should confirm the current tariff status directly before quoting, since this is the most actively changing trade situation of any market covered in this series."
        }
      },
      {
        "@type": "Question",
        "name": "Are common Indian spices and botanicals like turmeric and ginger exempt from US tariffs?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Many are, through an Annex II exemption list that excludes specific HTS-classified products from the Section 122 surcharge entirely. Spices including turmeric, ginger, and cinnamon, along with coffee, tea, and various tree nuts, were added to this exemption list in a November 2025 update and that exemption has carried forward into the current Section 122 regime. However, eligibility is determined strictly by the product's HTS classification code, not by its marketing description, so an extract or concentrate of an exempted raw spice may fall under a different HTS heading without the same exemption. Suppliers should confirm the exact HTS code for their specific product form, not assume the raw-ingredient exemption transfers automatically."
        }
      },
      {
        "@type": "Question",
        "name": "What labeling requirements apply to herbal ingredients sold as dietary supplements in the US?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Finished dietary supplement products must carry a Supplement Facts panel declaring each dietary ingredient and its amount per serving, a statement of identity naming the product as a supplement, the name and address of the manufacturer, packer, or distributor, country of origin, a complete ingredient list, and the standard FDA disclaimer stating that the product's claims have not been evaluated by the FDA and that it is not intended to diagnose, treat, cure, or prevent any disease. For raw botanical ingredients supplied to a US-based formulator rather than sold as a finished consumer product, the labeling burden typically shifts to the buyer who places the finished product on the market, but the supplier should still provide accurate documentation of plant part, extraction method, and country of origin to support the buyer's own compliance."
        }
      },
      {
        "@type": "Question",
        "name": "Does an Indian supplier need their own FDA registration to export herbal ingredients to the US?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes, in most cases. Foreign facilities that manufacture, process, pack, or hold food or dietary ingredients for export to the United States generally must register with the FDA, a registration that must be renewed during each even-numbered year, and must also comply with the Foreign Supplier Verification Program requirements that place responsibility on the US importer to verify that imported food meets US safety standards. An unregistered facility, or one with a lapsed registration, can cause a shipment to be detained at the port of entry regardless of how compliant the product itself is. Indian suppliers should treat FDA facility registration as a baseline precondition to any US-bound shipment, confirmed and current before the first order, not a step handled informally by a buyer."
        }
      }
    ]
  }
...
> **Sourcing for the US market?** Ayris Global connects qualified US buyers with GMP-certified Indian producers and supports NDI status checks, FDA facility registration verification, and full compliance documentation for dietary supplement and food-grade botanical supply. [Request samples](/contact/)
...
1. **Confirm FDA facility registration is current** for the supplying facility before the first shipment, and build renewal into an even-numbered-year compliance calendar rather than handling it reactively.
2. **Determine NDI status early** for any ingredient without an established US market history; an NDI notification has a 75-day minimum lead time before commercial introduction, which should be planned into any new-ingredient timeline, not discovered after a buyer asks.
3. **Be ready to support the buyer's FSVP file** with facility audit history, testing records, and identity documentation; this is a legal obligation on the importer, not an optional add-on, and proactive documentation shortens onboarding.
4. **Do not quote a fixed landed cost assuming today's tariff rate will hold** past July 24, 2026; confirm current Section 122, MFN, and any applicable Section 301 status directly with a customs broker at the time of quoting, not from this guide or any other static source.
5. **Check the exact HTS classification** for the specific product form being shipped, raw, powdered, or extracted, before assuming an Annex II spice exemption applies; classification, not marketing description, controls eligibility.
6. **Treat the broader US-India Bilateral Trade Agreement as not yet operative** for pricing purposes; it remains under negotiation with an explicit condition, stated by India's own Commerce Minister, that it will not take effect until specific tariff competitiveness terms are met.
7. **Maintain complete botanical identity and extraction documentation** even for raw ingredient supply, since the labeling and FSVP burden on the US buyer depends on accurate information the supplier is best positioned to provide.
...
**Further Reading:** [Entering the Australia and New Zealand Market: A Guide for Indian Herbal Ingredient Suppliers](/blog/anz-market-entry-herbal-ingredients-guide/) &middot; [Entering the EU Market: A Guide for Indian Herbal Ingredient Suppliers](/blog/eu-market-entry-herbal-ingredients-guide/) &middot; [GMP, ISO, FSSAI and Organic Certification for Indian Herbal Exports](/blog/gmp-iso-fssai-organic-certification-india-herbal/)

---

*Ayris Global connects qualified US buyers with verified, GMP-certified Indian producers of herbal extracts, Ayurvedic ingredients, and botanical powders, with full support for NDI status checks, FDA facility registration verification, and compliance documentation for dietary supplement and food-grade botanical supply. To discuss your sourcing requirements, contact our team at [sourcing@ayrisglobal.in](mailto:sourcing@ayrisglobal.in) or visit our [products page](/products/).*
