...
image: "/images/blog/blog-quality-testing-indian-herbal-ingredients-supplier.jpg"
imageAlt: "Laboratory analyst reviewing HPLC chromatogram output from Indian herbal ingredient quality testing"
faqSchema: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is a NABL-accredited laboratory and why does it matter for herbal ingredient COAs?","acceptedAnswer":{"@type":"Answer","text":"NABL (National Accreditation Board for Testing and Calibration Laboratories) is an autonomous body under the Government of India that accredits testing laboratories against ISO/IEC 17025:2017 -- the international standard for laboratory competence. NABL is a signatory to the ILAC Mutual Recognition Arrangement, which means test reports from NABL-accredited laboratories are accepted by regulatory bodies in the EU, USA, UK, Japan, Australia, and other major markets. For herbal ingredient buyers, a COA from a NABL-accredited laboratory is not simply a quality signal -- it is the minimum documentation baseline required for import compliance in most regulated markets. Critically, NABL accreditation is parameter-specific, not lab-wide: a laboratory may hold NABL accreditation for microbial testing but not for pesticide residue analysis. When reviewing a COA, confirm that the NABL accreditation scope of the issuing laboratory covers each specific parameter listed -- not merely that the lab holds some form of NABL certificate."}},{"@type":"Question","name":"What heavy metal limits apply to Indian herbal ingredients exported to the EU versus the USA?","acceptedAnswer":{"@type":"Answer","text":"Heavy metal limits differ by market and by ingredient category. For EU food supplement ingredients, the relevant limits are set under EC Regulation 1881/2006 on contaminants in food and under EFSA scientific opinions on herbal preparations. Commonly applied limits for botanical extracts are: lead up to 3 mg/kg, cadmium up to 1 mg/kg, mercury up to 0.1 mg/kg, and arsenic (inorganic) up to 1 mg/kg, though limits vary by product type and recent EFSA guidance has moved toward lower values for specific contaminants. For the USA, USP General Chapter <2232> Elemental Contaminants in Dietary Supplements applies to finished products, while ICH Q3D limits are used for pharmaceutical-grade ingredients. The limits are expressed as permitted daily exposures (PDEs) rather than concentration-in-material limits, so you must know your expected daily dose to calculate compliance. For Japanese import, the Food Sanitation Act specifies lead, cadmium, and arsenic limits for specific food categories. Best practice for multi-market supply is to test against ICP-MS and report results at the level of your strictest destination market requirement -- typically EU limits for EU-bound supply and USP limits or ICH Q3D-derived limits for US-bound supply."}},{"@type":"Question","name":"What is the EU default MRL of 0.01 mg/kg and which Indian herbal ingredients are most at risk?","acceptedAnswer":{"@type":"Answer","text":"Under EU Regulation (EC) No 396/2005, a default maximum residue limit (MRL) of 0.01 mg/kg applies to any pesticide-commodity combination not specifically listed in the regulation annexes. For Indian herbal ingredients, which include hundreds of active ingredient-pesticide combinations that have no established specific MRL, the default 0.01 mg/kg effectively functions as the applicable limit across most of the pesticide screening panel. This limit is analytically very low -- 10 parts per billion -- and requires LC-MS/MS and GC-MS/MS methods capable of reaching detection limits at or below that level to generate a defensible negative result. The Indian botanical ingredients most frequently flagged in EU border controls and FDA import alerts for pesticide contamination include turmeric, ashwagandha, ginger, and black pepper. Organochlorine, organophosphate, and pyrethroid compound classes are most commonly detected. Testing against US EPA tolerances alone is insufficient for EU-bound supply -- the EU default MRL of 0.01 mg/kg is typically stricter than the equivalent US tolerance for the same compound."}},{"@type":"Question","name":"What is the difference between USP and EP pharmacopoeia standards and which should I reference for Indian herbal ingredients?","acceptedAnswer":{"@type":"Answer","text":"USP (United States Pharmacopeia) and EP (European Pharmacopoeia) are independent standard-setting bodies with overlapping but not identical botanical monographs. USP monographs for botanicals are contained in USP-NF and the Herbal Medicines Compendium (HMC), and apply as legally enforceable standards for dietary supplement ingredients marketed in the USA under DSHEA. EP monographs for herbal substances are published by the European Directorate for the Quality of Medicines (EDQM) and are binding for pharmaceutical-grade ingredients in EU member states. Many major Indian herbal ingredients -- including ashwagandha, turmeric, boswellia, moringa, and tulsi -- have active monographs in one or both compendia. For buyers supplying the US supplement market, referencing the relevant USP monograph in your specification gives you an enforceable quality anchor and can reduce regulatory review burden under the NDI notification process. For buyers supplying European pharmaceutical or high-grade food supplement customers, EP monograph compliance signals a higher quality tier. Where a monograph exists in both, some buyers specify both -- noting that the more stringent limit for each parameter applies. For ingredients without an applicable monograph in either compendium, the Ayurvedic Pharmacopoeia of India (API) or WHO monographs on selected medicinal plants provide documented reference standards."}},{"@type":"Question","name":"How do I evaluate whether a COA result actually confirms my ingredient meets specification?","acceptedAnswer":{"@type":"Answer","text":"A COA that lists test results without specification limits is data without context -- it tells you what was found but not whether it passes. When reviewing a COA, look for three columns or equivalent information: the parameter tested, the result obtained, and the specification limit or range against which the result is judged. The result should fall within the specification range for the ingredient to be considered compliant. For active constituent assays, the specification might read: curcuminoids NLT 95.0% (not less than) or withanolides NLT 5.0%. For heavy metals, specifications are upper limits: lead NMT 3 mg/kg (not more than). For microbials, limits are typically maximum counts: total aerobic plate count NMT 10^5 CFU/g, with absence requirements for pathogens. For pesticide residues, the result should be expressed as a detected concentration (or as below the limit of quantitation, LOQ) against the applicable MRL. A result reported as not detected without an accompanying LOQ value is not a compliant data point -- the LOQ must be at or below the applicable MRL limit to make the not detected result meaningful. Always check the test date against the batch manufacture date: a COA where testing occurred more than three months after the stated manufacture date for a material with a two-year shelf life requires explanation."}}]}'
---
...
This post is a companion to the [supplier qualification and audit guide](/blog/qualify-audit-indian-ayurvedic-ingredient-supplier/) and the [complete sourcing guide for Indian herbal ingredients](/blog/how-to-source-herbal-ingredients-india-complete-guide/).
...
For buyers who need ingredient specifications developed, COA review support, or guidance on testing requirements for a specific market and ingredient combination, contact our sourcing team at [sourcing@ayrisglobal.in](mailto:sourcing@ayrisglobal.in) or on WhatsApp at [+91 97292 56621](https://wa.me/919729256621).
