---
title: "Indian Herbal Supplier Due Diligence Checklist"
description: "A practical six-layer checklist for international buyers vetting Indian herbal ingredient suppliers: legal entity verification, GMP certificates, export licensing, document review, red flags, and commercial checks."
pubDate: 2026-09-17
category: "sourcing"
region_tags: ["eu", "uk", "usa", "uae-gcc", "japan", "korea", "anz", "sea", "latam"]
image: "/images/blog/blog-indian-herbal-supplier-due-diligence-checklist.jpg"
faqSchema: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What documents should I request from an Indian herbal supplier before placing a first order?","acceptedAnswer":{"@type":"Answer","text":"Request a copy of their Import Export Code (IEC), GST registration, company incorporation certificate, GMP certificate, ISO or HACCP certificate where applicable, a current Certificate of Analysis (COA) for the specific ingredient, Technical Data Sheet (TDS), and Safety Data Sheet (SDS). For organic-claimed lines, also request the valid NOP, EU organic, or India NPOP certificate and the corresponding Transaction Certificate (TC) for the specific lot."}},{"@type":"Question","name":"How do I verify that an Indian supplier''s GMP certificate is genuine?","acceptedAnswer":{"@type":"Answer","text":"Contact the certification body named on the certificate directly, using contact details from the certification body''s own official website -- not from the certificate itself. Ask them to confirm the certificate number, scope, and current validity. For further detail on how to identify legitimate certifiers and what accreditation bodies to check, see our guide to verifying an Indian GMP certificate."}},{"@type":"Question","name":"What is an Import Export Code and why does it matter when sourcing from India?","acceptedAnswer":{"@type":"Answer","text":"An Import Export Code (IEC) is a 10-digit identifier issued by India''s Directorate General of Foreign Trade (DGFT). No Indian entity can legally export goods without one. Verifying that a supplier holds a valid, active IEC -- searchable on the DGFT public portal -- is the minimum legal check before proceeding with any sourcing relationship. A supplier who cannot or will not provide their IEC should not be taken further."}},{"@type":"Question","name":"What are the most common red flags when evaluating a new Indian herbal ingredient supplier?","acceptedAnswer":{"@type":"Answer","text":"Key red flags include: GMP or organic certificates issued by certification bodies with no traceable accreditation; COAs with rounded or suspiciously perfect assay values and no supporting third-party lab report; refusal to share IEC or GSTIN; payment terms requiring 100 percent advance to a personal bank account; pressure to move to a purchase order before documentation is reviewed; and sample quality that does not match the submitted COA."}},{"@type":"Question","name":"How long does supplier due diligence typically take when sourcing botanical ingredients from India?","acceptedAnswer":{"@type":"Answer","text":"A basic document review covering IEC, GMP certificate, COA, and TDS can be completed in two to three business days once the supplier responds. A more thorough process including independent third-party lab verification of a product sample typically takes two to four weeks. Buyers with regulatory obligations -- USFDA, UK FSA, EU food law, or TGA (Australia) -- should allow three to six weeks before committing to a purchase order."}}]}'
---
...
**GMP (Good Manufacturing Practice):** India has multiple GMP standards in circulation. WHO-GMP (Technical Report Series 986, Annex 2) is the most widely accepted internationally. USFDA-compliant GMP (21 CFR Parts 111 and 117) applies to dietary supplement and food manufacturers supplying the US market. EU-GMP applies to inputs into licensed medicinal products in Europe. Schedule M is India's domestic pharmaceutical standard and carries less international recognition on its own. Confirm which standard the certificate covers and verify the issuing body is accredited -- see our [complete guide to verifying an Indian GMP certificate](/blog/how-to-verify-indian-gmp-certificate-buyer-guide/) for the verification steps.
...
[Contact Ayris Global](/contact/) to discuss your ingredient requirements.
