...
faqSchema: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What Incoterm should I specify when sourcing herbal ingredients from India for the first time?","acceptedAnswer":{"@type":"Answer","text":"For a first shipment from India, FOB (Free on Board) named Indian port is the most common starting point and gives buyers a reasonable balance of control and simplicity. Under FOB, the Indian supplier handles export clearance and loading at the port of origin -- Nhava Sheva, Mundra, or Chennai -- and risk transfers to you once the goods are on board the vessel. You arrange and pay for the main ocean freight, marine insurance, and import clearance at destination. This means you can choose your own freight forwarder, compare rates directly, and maintain visibility over the main leg of transit. EXW (Ex Works) places even more responsibility on the buyer -- including inland haulage from the supplier''s facility to the port and export customs clearance -- which is operationally difficult if you do not have a trusted agent in India. CIF (Cost, Insurance, and Freight) shifts freight and insurance to the supplier, which simplifies the buyer''s workload but reduces your control over carrier selection and insurance quality. For ongoing supply relationships, experienced buyers typically move to FOB or FCA (Free Carrier) once they have established a freight forwarder relationship, as this gives the best control over landed cost."}},{"@type":"Question","name":"Which Indian port should I specify for exporting herbal ingredients to Europe or the USA?","acceptedAnswer":{"@type":"Answer","text":"For most herbal ingredient exports to Europe and the USA, Nhava Sheva (Jawaharlal Nehru Port, JNPT) near Mumbai is the default choice. It is India''s largest container port, handles over half of India''s containerised exports, and has the most frequent direct sailing schedules to Rotterdam, Hamburg, Felixstowe, and US East and West Coast ports. Transit time from Nhava Sheva to Rotterdam is approximately 18 to 22 days on direct services. Mundra Port in Gujarat is a strong alternative, particularly if your supplier is based in Rajasthan, Gujarat, or North India -- it can reduce inland haulage costs and offers competitive sailing frequency to Europe and the Middle East. Chennai Port suits suppliers in South India and offers better connectivity to Southeast Asian ports and to Japan and Korea via Singapore. For Japan-bound supply specifically, Chennai often provides a routing advantage over the west coast ports. When specifying your purchase order, state the port by name -- for example, FOB Nhava Sheva Incoterms 2020 -- not simply FOB India, which is an incomplete specification that can cause disputes over which port''s charges are included."}},{"@type":"Question","name":"What lead time should I realistically plan for when ordering herbal ingredients from India?","acceptedAnswer":{"@type":"Answer","text":"Total lead time from purchase order confirmation to goods received at your warehouse typically runs 10 to 16 weeks for a standard FCL or LCL sea freight shipment, though the range is wide depending on order complexity and destination. The main components are: production and quality testing at the Indian supplier (3 to 6 weeks, longer for made-to-spec extraction orders or if third-party NABL lab testing is required); export documentation preparation including COA, phytosanitary certificate, shipping bill, and commercial invoice (1 to 2 weeks); port booking and cut-off (allow 1 week); ocean transit (4 to 8 weeks depending on destination -- UAE 1 week, Europe 3 to 4 weeks, USA East Coast 4 to 5 weeks, Japan and Korea 3 to 4 weeks via Singapore, ANZ 4 to 6 weeks); and import clearance and last-mile delivery at destination (1 to 2 weeks, longer if your regulatory authority conducts physical inspection). The most common source of unplanned delay is documentation -- missing or incorrect phytosanitary certificates, COAs that do not match the specification in the purchase order, or HS code classification disputes at the destination port. Build a documentation checklist into your purchase order and confirm with your supplier that all documents will be available at least 3 days before the vessel cut-off date."}},{"@type":"Question","name":"What insurance should I take out on an Indian herbal ingredient shipment and who arranges it?","acceptedAnswer":{"@type":"Answer","text":"Under most Incoterms used for Indian herbal ingredient shipments -- FOB, FCA, and EXW -- the buyer is responsible for arranging marine cargo insurance from the point of risk transfer onward. Under CIF, the seller provides insurance but only to the Institute Cargo Clause C minimum, which is a named-perils policy covering a limited set of risks. For shipments of processed herbal extracts and botanical powders -- which carry some susceptibility to moisture damage and contamination -- buyers should arrange Institute Cargo Clause A (All Risks) coverage, which covers all physical loss or damage except specifically excluded perils. The insured value should be the invoice value of the goods plus freight plus 10 percent, as is standard practice and as specified in most trade finance documentation. For LCL (Less than Container Load) shipments, confirm that your insurance covers the consolidation and deconsolidation stages, not just the main vessel leg. Keep your insurance policy number and the insurer''s claims contact details accessible separately from the cargo documents -- if you need to make a claim, you will need this information at the destination port before customs release."}},{"@type":"Question","name":"What should I include in a purchase order to control landed cost and avoid hidden charges on Indian herbal ingredient shipments?","acceptedAnswer":{"@type":"Answer","text":"A purchase order that controls landed cost specifies: the Incoterm and named place in full (for example, FOB Nhava Sheva Incoterms 2020); the HS code classification for the ingredient (botanical extracts typically fall under HS 1302, dried herbs under 1211, and essential oils under 3301 -- confirm with your customs broker for your destination market); the currency of payment and payment terms; packaging specification including net weight, gross weight, number of bags or drums, and packaging material (food-grade HDPE drums or multi-wall kraft bags with inner poly liner are standard for herbal extracts and powders); documentation requirements listed explicitly, naming each document and the specification it must comply with (COA against your approved specification, NABL accreditation scope confirmation, phytosanitary certificate from India''s NPPO, bill of lading, commercial invoice, packing list, and any destination-specific certificates such as a Health Certificate for Japan or a Certificate of Origin for markets where preferential duty treatment applies under a bilateral trade agreement); the shelf life remaining at time of shipment (specify minimum percentage of total shelf life -- for example, minimum 75 percent of stated shelf life remaining at the time of shipment); and the latest acceptable shipment date. Charges that commonly create landed cost surprises include origin THC (Terminal Handling Charges) at the Indian port, which under FOB are the buyer''s responsibility and are often quoted separately by the freight forwarder; LCL handling surcharges; and destination port demurrage if documents are not available before the vessel arrives."}}]}'
---
...
This post is part of the [complete guide to sourcing herbal ingredients from India](/blog/how-to-source-herbal-ingredients-india-complete-guide/) and a companion to the [supplier qualification and audit guide](/blog/qualify-audit-indian-ayurvedic-ingredient-supplier/) and the [quality testing guide](/blog/quality-testing-indian-herbal-ingredients-supplier/).
...
Certificate of Analysis (COA) -- issued by the supplier or their third-party NABL-accredited laboratory, covering the specific batch being shipped. Must reference the batch number stated on the commercial invoice and packing list. See the [quality testing guide](/blog/quality-testing-indian-herbal-ingredients-supplier/) for what the COA must contain.
...
For buyers who need guidance on shipping logistics, documentation requirements, or supplier selection for a specific ingredient and destination market, contact our sourcing team at [sourcing@ayrisglobal.in](mailto:sourcing@ayrisglobal.in) or on WhatsApp at [+91 97292 56621](https://wa.me/919729256621).
